...
export default function EventsYearOverview({
  ...
  return (
    <section className="relative w-full min-h-screen flex flex-col justify-between pt-20 sm:pt-24 md:pt-12 pb-0">
      {/* Subtle Main Section Pattern Layer — enlarged whisper texture */}
      <div
      ...
      {/* Main Centered Content (PROJECT SHOWCASE in Figma Desktop 27 & iPhone 16) */}
              ...
              return (
                <motion.button
                  ...
                  className={`group/item relative flex-1 py-2 sm:py-3.5 md:py-6 px-2 flex items-center justify-center text-center transition-all duration-200 hover:bg-white/[0.04] active:bg-white/[0.08] cursor-pointer touch-manipulation select-none ${
                    idx < years.length - 1 ? "border-b border-white/20" : ""
                  }`}
                >
                  {/* Year Label - Solid green #67FFAF on hover, active tap, and click */}
                  <span
      ...
      <motion.div
        ...
        className="w-full relative mt-10 sm:mt-14 md:mt-20 h-[140px] sm:h-[180px] md:h-[240px] lg:h-[300px] xl:h-[340px] events-banner-gradient border-t border-white/10 overflow-hidden flex items-center justify-center"
      >
        {/* Layer 1: Left Purple Banner Holder - Pinned Flush to Left Edge */}
        ...
        {/* Right Purple Banner Holder - Pinned Flush to Right Edge */}
        ...
        {/* Layer 2: Geometric Pattern texture with 10% opacity */}
        <div
        ...
        {/* Layer 3: Center Text (Full 40px Jost Bold from Figma) */}
